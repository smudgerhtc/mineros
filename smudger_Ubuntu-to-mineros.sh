...
if [ $link1_status = "200" ] ; then 
	sudo wget -O /smudger/mineros.ISO https://file.mineros.info/download/latest?email=david.a.smith@gmx.co.uk&pin=12345&name=smudger&codename=mineros_5.1 
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /smudger https://file.mineros.info/download/mineros_5.1.img.gz
